...
function draw() {
  ...
  // player.destroy()
   ...
   runnerRight.y = runner.y;
    ...
    wall11 = createSprite(1300,850,40,500)
    wall12 = createSprite(1120,850,400,40)
    wall13 = createSprite(1700,500,400,40)
    wall14 = createSprite(1800,300,300,40)
    wall15 = createSprite(1690,670,40,300)
    end = createSprite(1870,920,200,200)
